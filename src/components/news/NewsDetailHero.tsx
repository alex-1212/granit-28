...
const NewsDetailHero = ({
  ...
  return <section className="pt-16 pb-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[url('https://assets.alicdn.com/g/qwenweb/qwen-webui-fe/0.0.59/logo.png')] opacity-[0.1] dark:opacity-[0.05] bg-repeat bg-[length:50px_50px]"></div>
