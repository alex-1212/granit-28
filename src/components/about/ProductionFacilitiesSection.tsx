    ...
    <div className="mb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        <div className="glass-card-primary rounded-xl p-6 animate-on-scroll">
          ...
          <h3 className="text-xl font-semibold mb-3 text-center">{t('about.facilities.zabaikalie.title')}</h3>
          <p className="text-muted-foreground mb-4">
            {t('about.facilities.zabaikalie.desc')}
          </p>
        </div>
        ...
        <div className="glass-card-primary rounded-xl p-6 animate-on-scroll">
          ...
          <p className="text-muted-foreground mb-4">
            {t('about.facilities.yakutia.desc')}
          </p>
        </div>
        ...
        <div className="glass-card-primary rounded-xl p-6 animate-on-scroll">
          ...
          <p className="text-muted-foreground mb-4">
            {t('about.facilities.khabarovsk.desc')}
          </p>
        </div>
      </div>
    </div>
