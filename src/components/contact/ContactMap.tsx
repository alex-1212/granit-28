      ...
      <div className="flex gap-4 mb-6">
        ...
        >
          <Button
            variant="outline"
            size="sm"
            className="w-full py-3 font-semibold flex gap-2 justify-center text-primary border-primary hover:bg-primary/10"
          >
        ...
        >
          <Button
            variant="outline"
            size="sm"
            className="w-full py-3 font-semibold flex gap-2 justify-center text-[#ffcc00] border-[#ffcc00] hover:bg-[#ffcc0055]"
          >
