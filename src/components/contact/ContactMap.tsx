...
const ContactMap: React.FC = () => {
  ...
  return <div>
      ...
      {/* 1. Карта */}
      <div className="glass-card rounded-xl overflow-hidden h-[400px] mb-4">
      ...
      <div className="flex gap-4 mb-6">
        <a href={GOOGLE_MAPS_URL} className="flex-1" target="_blank" rel="noopener noreferrer">
          <Button variant="outline" size="sm" className="w-full py-3 font-semibold flex gap-2 justify-center border-primary hover:bg-primary/10 text-zinc-50">
            <Map className="mr-2" size={18} />
            Google Maps
          </Button>
        </a>
        <a href={YANDEX_MAPS_URL} className="flex-1" target="_blank" rel="noopener noreferrer">
          <Button variant="outline" size="sm" className="w-full py-3 font-semibold flex gap-2 justify-center text-[#ffcc00] border-[#ffcc00] hover:bg-[#ffcc0055]">
