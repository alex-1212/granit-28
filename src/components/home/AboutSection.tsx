        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-4 animate-on-scroll">
                ...
                <div>
                  <h3 className="mb-1 font-semibold text-zinc-100 my-[8px] py-0 mx-0 px-0 text-lg">{t('home.about.independence.title')}</h3>
                  <p className="text-muted-foreground">{t('home.about.independence.description')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 animate-on-scroll">
                ...
                <div>
                  <h3 className="font-semibold mb-1 my-[8px] text-zinc-100 text-lg">{t('home.about.harshConditions.title')}</h3>
                  <p className="text-muted-foreground">{t('home.about.harshConditions.description')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 animate-on-scroll">
                ...
                <div>
                  <h3 className="font-semibold mb-1 my-[8px] text-zinc-100 text-lg">{t('home.about.capacity.title')}</h3>
                  <p className="text-muted-foreground">{t('home.about.capacity.description')}</p>
                </div>
              </div>
            </div>
          ...
          <div className="relative">
            ...
            <div className="glass-card rounded-2xl overflow-hidden aspect-video relative animate-on-scroll">
              <img alt={t('home.about.cta.more')} className="object-cover w-full h-full" src="/uploads/8cd4e9b3-ca81-4bad-9d50-3f4e61f8515b.webp" />
            </div>
            ...
            <div className="absolute -bottom-8 -left-8 glass-card-accent rounded-xl p-4 max-w-[250px] animate-on-scroll">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="font-semibold">{t('home.about.licenses.title')}</h4>
              </div>
              <p className="text-sm text-inherit">{t('home.about.licenses.description')}</p>
              <Link to="/licenses" className="text-primary text-sm font-medium mt-2 inline-flex items-center gap-1 hover:underline">
                {t('home.about.licenses.viewAll')}
              </Link>
            </div>
          </div>
        </div>
