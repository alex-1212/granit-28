      ...
      <section className="py-16 w-full">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="prose dark:prose-invert max-w-none mb-16 animate-on-scroll">
            ...
            <p className="text-lg mb-6">Наши машины используются для приготовления промышленных эмульсионных взрывчатых веществ (ВВ) гранулитов непосредственно на объекте.</p>
