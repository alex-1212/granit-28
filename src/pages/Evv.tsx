            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Производство и применение эмульсионных ВВ оказывают минимальное воздействие на окружающую среду, включая атмосферу и грунтовые воды.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Наша команда непрерывно работает над улучшением формул и технологий, чтобы предоставлять потребителям инновационные продукты</p>
                </div>
              </div>
